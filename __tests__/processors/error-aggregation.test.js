...
describe('ErrorAggregationProcessor', () => {
    ...
    describe('Error Pattern Recognition', () => {
        it('should detect error patterns', async () => {
            const error = new Error('Test error with ID 123 and timestamp 2024-01-17');
            const similarError = new Error('Test error with ID 456 and timestamp 2024-01-18');
            ...
            const result = await processor.process({ context: {}, data: {}, error: similarError });
        ...
        it('should handle different error types', async () => {
            ...
            const result1 = await processor.process({ context: {}, data: {}, error: error1 });
            const result2 = await processor.process({ context: {}, data: {}, error: error2 });
