...
## Commit Context
- **Current commit:** `5a90329dfe2eb4590b2d9bdc7c3ae34699bff928`
- **Branch:** `main`
- **Comparing since:** `HEAD~1`
- **Generated:** 2025-07-20T08:58:33.110Z
- **Last commit:** fix(types): resolve controller refactor regressions

## Summary
- **5 files changed** (+192 / -9 lines, net +183)
...
|--------|--------|------|-------------|
| `EmojiConsoleController` | removed | src/browser/transports/emoji-console.ts | Breaking |

## Export Changes
**Removed (1):**
- `EmojiConsoleController` from src/browser/transports/emoji-console.ts

## Public API Drift
| Symbol | Status | Cat | Hash (old→new) | Notes |
|--------|--------|-----|----------------|-------|
| `EmojiConsoleController` | removed | core | 5bda8160 | Breaking removal |

## Symbol Moves & Internalizations

| Symbol | Previous Location | New Location/Access | Rationale |
|--------|------------------|---------------------|----------|
| `EmojiConsoleController` | src/browser/transports/emoji-console.ts | Internalized (implementation detail) | Encapsulated within module boundary |
...
```json
{
  "timestamp": "2025-07-20T08:58:33.110Z",
  "tsErrors": 0,
  "eslintErrors": 0,
  "cycles": [],
  "graphHash": "17666177",
