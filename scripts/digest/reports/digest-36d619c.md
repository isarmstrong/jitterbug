...
## Commit Context
- **Current commit:** `36d619ceb444af700a6006a4fb898f185ebd2eff`
- **Branch:** `main`
- **Comparing since:** `HEAD~1`
- **Generated:** 2025-07-20T07:36:28.141Z
- **Last commit:** feat(logs): add branch/level filtering - Phase 2

## Summary
- **5 files changed** (+231 / -3 lines, net +228)
...
|--------|--------|-----|----------------|-------|
| `logInspector` | changed | util | 2ad9c61a→ad6c9a | — |
...
```json
{
  "timestamp": "2025-07-20T07:36:28.141Z",
  "tsErrors": 0,
  "eslintErrors": 0,
  "cycles": [],
  "graphHash": "6b377318",
