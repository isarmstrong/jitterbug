...
## Commit Context
- **Current commit:** `c4610e0dc27bcd34ec5c4090dac3b5cd71eaf476`
- **Branch:** `main`
- **Comparing since:** `HEAD~1`
- **Generated:** 2025-07-21T08:44:00.237Z
- **Last commit:** fix(security): P4.3 red-team Priority 1-2 runtime safety fixes

## Summary
- **5 files changed** (+147 / -41 lines, net +106)
- **Public surface:** +2 exports (DEFAULT_HMAC_CONFIG, parseHmacKeys)
...
|--------|--------|------|-------------|
| `DEFAULT_HMAC_CONFIG` | added | src/hub/security/index.ts | Additive |
| `parseHmacKeys` | added | src/hub/security/index.ts | Additive |

## Export Changes
**Added (2):**
- `DEFAULT_HMAC_CONFIG` in src/hub/security/index.ts
- `parseHmacKeys` in src/hub/security/index.ts

## Public API Drift
| Symbol | Status | Cat | Hash (old→new) | Notes |
|--------|--------|-----|----------------|-------|
| `HmacConfig` | changed | core | 978cfb7→4af8d83a | — |
| `DEFAULT_HMAC_CONFIG` | changed | util | 6f8c66d→5aaa183e | — |
| `createHmacSigner` | changed | core | 7748543b→b6a2a34 | — |
| `parseHmacKeys` | changed | core | 1ba36b92→2aad5540 | — |
| `SecurityConfig` | changed | core | 5b258ba8→7d1d9a0 | — |
| `DEFAULT_SECURITY_CONFIG` | changed | util | 10d7932b→240a7c98 | — |
| `DEFAULT_HMAC_CONFIG, parseHmacKeys ` | new | util | 6feaba0 | — |
...
```json
{
  "timestamp": "2025-07-21T08:44:00.237Z",
  "tsErrors": 0,
  "eslintErrors": 0,
  "cycles": [],
  "graphHash": "293caebb",
