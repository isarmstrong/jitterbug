...
## [0.1.6.alpha] - 2025-02-05

### Added
- Edge Boundary Layer (EBL) for improved runtime debugging
  - Real-time memory monitoring and automatic cleanup
  - Type-safe validation across Edge runtime boundaries
  - Seamless integration with Sentry in production
- Enhanced developer experience
  - Improved error messages with context preservation
  - Better type inference in IDE environments
  - Automatic runtime detection and configuration

### Changed
- Updated version numbers across the project to 0.1.6
- Improved SSE transport reliability
  - Automatic reconnection on connection loss
  - Better backpressure handling for large log volumes
  - Smarter memory management in Edge runtime
- Enhanced type validation with progressive enhancement
  - Gradual type checking based on runtime capabilities
  - Better error reporting for type mismatches
  - Reduced memory footprint in production

### Fixed
- Memory leaks in long-running Edge functions
- Type inference issues affecting IDE experience
- SSE connection stability in Next.js 13/14/15
- Hydration mismatches in React Server Components

### Security
- Improved sensitive data handling in logs
- Enhanced runtime validation in Edge environments
- Better error stack sanitization
